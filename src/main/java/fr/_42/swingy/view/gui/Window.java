package fr._42.swingy.view.gui;

import fr._42.swingy.Utility.EType;
import fr._42.swingy.Utility.Logger;
import fr._42.swingy.Utility.Print;
import fr._42.swingy.Utility.Utility;
import fr._42.swingy.controller.CharacterFactory;
import fr._42.swingy.controller.GameManager;
import fr._42.swingy.controller.MapFactory;
import fr._42.swingy.database.DbHandler;
...
class Window extends JFrame {
    ...
    private static final String ASSETS_DIR = "src/main/java/fr/_42/swingy/assets/";
    ...
    private void initComponents(Window win) {
        ...
        batImage = Utility.loadImage(ASSETS_DIR + "bat.png");
            ...
            for (int j = 0; j < squareMap.getMapSize(); j++) {
                ...
                switch (value) {
                    case 1:
                        ...
                        break;
                    case 2:
                        cell.setBackground(new Color(171, 127, 127));
                        SwingUtilities.invokeLater(new Runnable() {
                            @Override
                            public void run() {
                                scaled = batImage.getScaledInstance(cell.getWidth(), cell.getHeight(), Image.SCALE_DEFAULT);
                                if (scaled != null) {
                                    JLabel picLabel = new JLabel(new ImageIcon(scaled));
                                    cell.add(picLabel);
                                    pack();
                    ...
                    case 8:
                        ...
                        break;
                    default:
                        cell.setBackground(new Color(255,222,173));
                        break;
                }
                panelGrid.add(cell);
